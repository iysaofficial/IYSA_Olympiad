    ...
    return(
        ...
        <header>
            <Link href="/">
                <Image 
                    className='logo-nav' 
                    src="/assets/images/logo/IYSAOlympiad.webp" 
                    alt="IYSA Olympiad Logo" 
                    width={100} 
                    height={50}
                    priority
                />
            ...
            <div className='navigation'>
                <ul className='menu'>
                    ...
                    <li className='menu-item'>
                        <Link href="/#category-main-section">Olympiad Event</Link>
                    </li>
                    <li className='menu-item'>
                        <Link href="/#news-main-section">News</Link>
                    </li>
                    <li className='menu-item'>
