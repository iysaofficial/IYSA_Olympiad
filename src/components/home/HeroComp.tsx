    ...
    return(
        ...
        <section className="hero-section" id="home">
            <div className="hero-content">
                ...
                <h3></h3>
                <p className="">IYSA Olympiad is designed to test your intelligence, creativity and perseverance. With more and more diverse participants, each subject category now gets its own stage, giving every brilliant participant like you a greater chance to shine. lets choose your event</p>
